...
export function pak14(value: string): void {
	replicants.lowerThird.tmpDaktronics.pak14.value = value || "N/A";
}

export function pak29(value: string): void {
	replicants.lowerThird.tmpDaktronics.pak29.value = value || "N/A";
}

export function pak40(value: string): void {
	replicants.lowerThird.tmpDaktronics.pak40.value = value || "N/A";
}

export function pak48(value: string): void {
	replicants.lowerThird.tmpDaktronics.pak48.value = value || "N/A";
}

export function pak88(value: string): void {
	replicants.lowerThird.tmpDaktronics.pak88.value = value || "N/A";
}

export function pak160(value: string): void {
	replicants.lowerThird.tmpDaktronics.pak160.value = value || "N/A";
}

export function pak201(value: string): void {
	replicants.lowerThird.tmpDaktronics.pak201.value = value || "N/A";
}

export function pak226(value: string): void {
	replicants.lowerThird.tmpDaktronics.pak226.value = value || "N/A";
}

export function pak236(value: string): void {
	replicants.lowerThird.tmpDaktronics.pak236.value = value || "N/A";
}

export function pak286(value: string): void {
	replicants.lowerThird.tmpDaktronics.pak286.value = value || "N/A";
}

export function pak296(value: string): void {
	replicants.lowerThird.tmpDaktronics.pak296.value = value || "N/A";
}
